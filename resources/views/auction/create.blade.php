                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="opening_price" name="opening_price" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="increment_bid">Price increment</label>
                                    <input type="number" id="increment_bid" name="increment_bid" class="form-control" value="1">
                                </div>
                                <hr>
                                <div class="form-group">
